...
if(isset($_POST['submit'])){
	...
	if(!empty($name) and !empty($amount) and !empty($date)){
		$query="insert into weekly_employee_payments(name,amount,date) values('$name','$amount', '$date')";
...
<!--Main Content Start-->
	<div id="main">
		<div class="well ">
				<h3 style="text-align: center; font-family: oblique;font-weight: 600">কর্মচারীর সাপ্তাহিক বেতন</h3><br>
